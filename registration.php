...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">Scott's Final Registration Page</a>
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-signin">
                      ...
                      <div class="form-label-group">
                        <input type="text" id="inputf_name" class="form-control" placeholder="First Name" required autofocus>
                        <label for="inputfname">Frist Name</label>
                      </div>

                      <div class="form-label-group">
                        <input type="email" id="inputl_name" class="form-control" placeholder="Last Name" required autofocus>
